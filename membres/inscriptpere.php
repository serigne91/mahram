...
//ajout enregistrement d'un fils dans la table identifiant
	$sqlInsert1="insert into identifiant (id_key, id_key_pere, id_key_mere, statut_social, virtuel, generation, id_key_epoux) values ('$id_key', '$id_key_refinscript', 'idkeymere', '$couple', 'N', '1', '$id_keyC')";
...
// demande si la mère est deja inscrite
?>
<hr>Votre mère est-elle dans la liste ?
...
<?php
 ...
 <input type="submit" value="oui" name="mere_update">
 <input type="submit" value="non" name="mere_update">
</form>
 <?php
//si qlq1 deja inscrit sous ce nom/prenom
} else {
	echo "<b><font color=red>Apparement tu es déjà inscrit</font></b><br><a href=\"indexMF.php?login=";
	echo $login;
	echo "\">Retour</a>";
}	
		?>
