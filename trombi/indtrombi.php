...
if ($prenomdumere=="Non_enregistré" && $prenomdupere!=="Non_enregistré") {
	echo "<tr><td align=center colspan=".$countenf.">"
			."<a href=indexmf.php?trombibox=oui&coordosbox=&listbox=&reftrombi=".$keydupere.">"
			."<img src=../trombi/images/mini/".$photodupere." width=100 height=50 alt=".$prenomdupere."></a>"
			// ."<a href=indexmf.php?trombibox=oui&coordosbox=&listbox=&reftrombi=".$keydumere.">"
			// ."<img src=../trombi/images/mini/".$photodumere." width=100 height=50 alt=".$prenomdumere." hspace=20></a>"
...
while($fs<$countfs) {
		...
		echo "<br><a href=indexmf.php?trombibox=oui&coordosbox=&listbox=&reftrombi=".$keyfs[$fs]."><img src=../trombi/images/mini/".$photofs[$fs]." width=100 height=50 alt=".$prenomfs[$fs]."></a>";
		...
		if ($keyepouxfs[$fs]<>"") {
			$contagetab=$contagetab+1;
			//echo $contagetab;
			echo "<a href=indexmf.php?trombibox=oui&coordosbox=&listbox=&reftrombi=".$keyfsC[$fs]."><img src=../trombi/images/mini/".$photofsC[$fs]." width=100 height=50 alt=".$prenomfsC[$fs]."></a>";
		}
...
//echo $countfs;
		...
		echo "<br><a href=indexmf.php?trombibox=oui&coordosbox=&listbox=&reftrombi=".$key[$enf]."><img src=../trombi/images/mini/".$photo[$enf]." width=100 height=50 alt=".$prenom[$enf]."></a>";
		if ($keyepoux[$enf]<>"") {
			//echo $prenomC[$enf].$nomC[$enf];
			echo "<a href=indexmf.php?trombibox=oui&coordosbox=&listbox=&reftrombi=".$keyC[$enf]."><img src=../trombi/images/mini/".$photoC[$enf]." width=100 height=50 alt=".$prenomC[$enf]."></a>";
		}
		echo "</td>";
		$enf=$enf+1;
	}
...
<?php	
	...
	?>
	<form name="FormName">
		<font color=red size=2>Tapez votre mot de passe pour modifier votre profil</font><br>
		...
		<a href="JavaScript:choisir(this.ModifPass,this.ModifId)"><img src="images/modif.gif" border=0></a>
	</form>
